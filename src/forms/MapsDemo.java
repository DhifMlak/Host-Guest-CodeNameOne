...
public class MapsDemo {
    ...
    public MapsDemo (Resources theme,Randonnee r) {
        this.r = r;
        this.theme=theme;
        ...
        try {
            ...
            ConnectionRequest req = new ConnectionRequest() {
                ...
                protected void readResponse(InputStream input) throws IOException {
                    ...
                    Image im = theme.getImage("red_pin.png");
            ...
            //4)Replace it here
            String key = "AIzaSyDP9x7SARdWdBzZhIjq3pJF7VcHkyjsdjw";
    ...
    private void putMeOnMap(MapComponent map) {
        try {
            ...
            ConnectionRequest req = new ConnectionRequest() {
                ...
                protected void readResponse(InputStream input) throws IOException {
                    ...
                    for (int i = 0; i < v.size(); i++) {
                        Hashtable entry = (Hashtable) v.elementAt(i);
                        Hashtable geo = (Hashtable) entry.get("geometry");
                        Hashtable loca = (Hashtable) geo.get("location");
                        Double lat = (Double) loca.get("lat");
                        System.out.println("my own lat :"+lat);
                        loc.setLatitude(lat);
                        Double lng = (Double) loca.get("lng");
                        System.out.println("my own lng :"+lng);
            ...
            req.setUrl("https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=34.683616, 9.454009&radius=5000&keyword="+place+"&key=AIzaSyDP9x7SARdWdBzZhIjq3pJF7VcHkyjsdjw");
            NetworkManager.getInstance().addToQueue(req);
            ...
            Image i = theme.getImage("blue_pin.png");
    ...
    class BackCommand extends Command {
        ...
        public void actionPerformed(ActionEvent evt) {
            RandoDetailsForm rdf = new RandoDetailsForm(r, theme);
            rdf.getF().showBack();
